...
| 10 | métier | Le patient doit pouvoir chercher des médecins selon leur spécialité. | Faciliter l'expérience utilisateur. | MOA | L'utilisateur doit pouvoir chercher un médecin en fonction de son besoin. | 3 | 5 | 01 |  |
| 11 | fonctionnelle | Utilisation d'une base donnée. | Faciliter la gestion de l'application. | MOA |  | 3 | 5 |  |  |
| 12 | métier | Le patient doit pouvoir chercher des médecins selon leut location | Faciliter l'expérience utilisateur | MOA | L'utilisateur doit pouvoir chercher un médecin en fonction de son emplacement | 3 | 5 |  |  |
